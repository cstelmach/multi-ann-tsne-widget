...
def fast_tsne(X,
    ...
    with open('/Applications/Orange3.app/Contents/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/Orange/widgets/bakk/data.dat', 'wb') as f:
        n, d = X.shape
    ...
    # run t-sne
    subprocess.call(['/Applications/Orange3.app/Contents/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/Orange/widgets/bakk/fitsne/' +
        '/bin/fast_tsne', version_number, 'data.dat', 'result.dat', '{}'.format(nthreads)])

    # read data file
    with open('/Applications/Orange3.app/Contents/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/Orange/widgets/bakk/result.dat', 'rb') as f:
