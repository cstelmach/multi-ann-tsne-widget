...
from Orange.projection.manifoldannoy import TSNEModel, TSNE
...
class TSNERunner:
    def __init__(self, tsne: TSNEModel, step_size=50, exaggeration=1):
        """
        Initialise TSNERunner class
        Input: tsne-Model, step_size, exaggeration
        """
        self.embedding = tsne
    ...
    def run_optimization(self):
        ...
        # calulate total number of iterations
